...
export const metadata = {
  title: 'دربارهٔ نردبان | نیازمندی‌های رایگان',
  description: 'نردبان، پایگاه خرید و فروش بی‌واسطه — آشنایی با ما',
};
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white">
        <div className="bg-gradient-to-br from-brand to-brand-dark px-8 py-12 text-center text-white">
          ...
          <h1 className="mt-4 text-2xl font-black">نردبان</h1>
        ...
        <div className="space-y-6 p-8 text-[15px] leading-8 text-gray-700">
          <section>
            ...
            <p>
              نردبان با هدف ساده‌ای ساخته شده: هر کسی بتواند در چند دقیقه چیزی را که لازم ندارد
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/terms" className="font-bold text-brand underline">قوانین نردبان</Link>{' '}
              بخوانید.
            </p>
          </section>
        </div>
