...
const FAQS = [
  ...
  },
  {
    ...
    a: 'به «نردبان من ← آگهی‌های من» بروید. روی هر آگهی دکمهٔ «ویرایش» و «حذف» وجود دارد. توجه: ویرایش محتوایی، آگهی را دوباره به صف بررسی می‌فرستد.',
  },
  {
  ...
  },
  {
    ...
    a: 'از «نردبان من» سوییچ نوتیفیکیشن را روشن کنید و به مرورگر اجازهٔ Notification بدهید. نوتیفیکیشن فقط روی HTTPS (یا localhost) کار می‌کند و در iOS نیاز به نصب وب‌اپ روی صفحه اصلی دارد.',
  },
  {
    q: 'با آگهی متخلف یا کلاهبردار مواجه شدم!',
    a: 'در صفحهٔ همان آگهی روی «گزارش تخلف آگهی» بزنید و دلیل را انتخاب کنید. تیم نردبان در اسرع وقت بررسی می‌کند. اگر مبلغی پرداخت کرده‌اید، سریعاً به پلیس فتا (cyberpolice.ir) گزارش دهید.',
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-5 text-center">
        ...
        <h1 className="mt-3 text-2xl font-black text-gray-900">پشتیبانی نردبان</h1>
