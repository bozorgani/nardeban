...
export const CATEGORY_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'قطعات یدکی و لوازم جانبی', slug: 'car-parts', children: [
        { name: 'قطعات یدکی خودرو', slug: 'car-spare-parts' },
        { name: 'لوازم جانبی خودرو', slug: 'car-accessories' },
        { name: 'قطعات موتورسیکلت', slug: 'motorcycle-parts' },
      ]},
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'خوردنی و آشامیدنی', slug: 'food-drink' },
      { name: 'فرش، گلیم و موکت', slug: 'carpets' },
      { name: 'لوازم دکوری و تزئینی', slug: 'decoration' },
      { name: 'نور و روشنایی', slug: 'lighting' },
      { name: 'تشک، روتختی و رختخواب', slug: 'bedding' },
      { name: 'شست‌وشو و نظافت', slug: 'cleaning-supplies' },
      { name: 'خیاطی و بافتنی', slug: 'sewing-knitting' },
      { name: 'باغبانی و گیاهان', slug: 'gardening' },
    ],
  },
  {
    ...
    children: [
      ...
      { name: 'خودرو و موتورسیکلت', slug: 'vehicle-services' },
      { name: 'مالی، حقوقی و بیمه', slug: 'financial-legal' },
      { name: 'برنامه‌نویسی و فناوری', slug: 'it-services' },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'حیوانات', slug: 'pets', children: [
        ...
        { name: 'خرگوش و جوندگان', slug: 'rodents' },
        { name: 'سایر حیوانات', slug: 'other-pets' },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'رستوران و کافی‌شاپ', slug: 'restaurant-jobs' },
      { name: 'حمل و نقل و رانندگی', slug: 'driver-jobs' },
      { name: 'آموزشی', slug: 'teaching-jobs' },
    ],
  },
];
