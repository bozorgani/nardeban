...
### [x] BE-05 🟠 رفع N+1 در شمارندهٔ جستجوهای ذخیره‌شده ✅ (کامیت c76c8c5)
...
### [x] DB-01 🟠 ایندکس‌محور کردن جستجوی آگهی (hybrid text+regex) ✅ (کامیت a474417)
...
### [x] FE-01 🟠 رفع دوبار fetch + دوبار افزایش بازدید ✅ انجام شد (کامیت `41b2adc`)
...
### [x] CL-02 🟡 حذف وابستگی بلااستفاده bcryptjs ✅ (کامیت 69dbb88)
